...
maps.n["j"] = { "gj", desc = "Navigate to the bottom screenline" }
maps.n["k"] = { "gk", desc = "Navigate to the top screenline" }
...
maps.n["<leader>;"] = { "<cmd>Telescope buffers sort_mru=true<cr>", desc = "Find buffers" }
maps.n["<leader><leader>"] = { "<C-^>", desc = "Jump to last buffer" }
